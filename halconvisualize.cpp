...
void HalconVisualize::analyze_graph_event (HObject ho_BackgroundImage, HTuple hv_MouseMapping, HTuple hv_Button,
...
void HalconVisualize::color_string_to_rgb (HTuple hv_Color, HTuple *hv_RGB)
{
...
void HalconVisualize::determine_optimum_pose_distance (HTuple hv_ObjectModel3DID, HTuple hv_CamParam,
...
void HalconVisualize::dev_update_off ()
{
...
void HalconVisualize::disp_continue_button (HTuple hv_WindowHandle)
{
...
void HalconVisualize::disp_message (HTuple hv_WindowHandle, HTuple hv_String, HTuple hv_CoordSystem,
...
void HalconVisualize::disp_object_model_no_opengl (HObject *ho_ModelContours, HTuple hv_ObjectModel3DID,
...
void HalconVisualize::disp_text_button (HTuple hv_WindowHandle, HTuple hv_String, HTuple hv_CoordSystem,
...
// Chapter: Graphics / Output
void HalconVisualize::disp_title_and_information (HTuple hv_WindowHandle, HTuple hv_Title, HTuple hv_Information)
{
...
void HalconVisualize::dump_image_output (HObject ho_BackgroundImage, HTuple hv_WindowHandleBuffer,
...
void HalconVisualize::gen_cam_par_area_scan_division (HTuple hv_Focus, HTuple hv_Kappa, HTuple hv_Sx,
...
void HalconVisualize::get_cam_par_data (HTuple hv_CameraParam, HTuple hv_ParamName, HTuple *hv_ParamValue)
{
...
void HalconVisualize::get_cam_par_names (HTuple hv_CameraParam, HTuple *hv_CameraType, HTuple *hv_ParamNames)
{
...
void HalconVisualize::get_object_models_center (HTuple hv_ObjectModel3DID, HTuple *hv_Center)
{
...
void HalconVisualize::get_trackball_center (HTuple hv_SelectedObject, HTuple hv_TrackballRadiusPixel,
...
void HalconVisualize::get_trackball_center_fixed (HTuple hv_SelectedObject, HTuple hv_TrackballCenterRow,
...
void HalconVisualize::max_line_width (HTuple hv_WindowHandle, HTuple hv_Lines, HTuple *hv_MaxWidth)
{
...
void HalconVisualize::project_point_on_trackball (HTuple hv_X, HTuple hv_Y, HTuple hv_VirtualTrackball,
...
void HalconVisualize::set_cam_par_data (HTuple hv_CameraParamIn, HTuple hv_ParamName, HTuple hv_ParamValue,
...
void HalconVisualize::set_display_font (HTuple hv_WindowHandle, HTuple hv_Size, HTuple hv_Font, HTuple hv_Bold,
    HTuple hv_Slant)
{
...
void HalconVisualize::trackball (HTuple hv_MX1, HTuple hv_MY1, HTuple hv_MX2, HTuple hv_MY2, HTuple hv_VirtualTrackball,
...
void HalconVisualize::tuple_vector_cross_product (HTuple hv_V1, HTuple hv_V2, HTuple *hv_VC)
{
...
void HalconVisualize::visualize_object_model_3d (HTuple hv_WindowHandle, HTuple hv_ObjectModel3D,
  ...
  try
  {
    ...
    while (0 != 1)
    {
      ...
      while (0 != 1)
      {
        ...
        try
        {
          GetMpositionSubPix(hv_WindowHandle, &hv_GraphButtonRow, &hv_GraphButtonColumn, &hv_GraphButton);
