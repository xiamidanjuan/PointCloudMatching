    ...
    HTuple hv_ImageCoverage, HTuple hv_PoseIn, HTuple* hv_PoseOut)
{
    ...
    if (0 != ((((hv_BB.TupleAbs()).TupleConcat(0)).TupleSum()) == 0.0))
    {
        hv_BB.Clear();
    ...
    HTuple hv_ObjectModel3D, HTuple hv_Poses, HTuple* hv_TBCenter, HTuple* hv_TBSize)
{
    ...
    }
    {
        ...
        {
            if (0 != (HTuple(hv_SelectedObject[hv_Index]).TupleAnd(HTuple(hv_Diameter[hv_Index]) > 0)))
            {
...
void action()
{
    ...
    // Local control variables
    HTuple  hv_WindowHandle, hv_ModelPath, hv_CloudPath;
    ...
    for (hv_Index = 1; hv_Index <= 5; hv_Index += 1)
    {
        ReadObjectModel3d(hv_CloudPath, "m", HTuple(), HTuple(), &hv_ObjectModel3D1,
            &hv_Status1);
        SelectPointsObjectModel3d(hv_ObjectModel3D1, "point_coord_z", 0.5, 1, &hv_ObjectModel3DThresholded);
        FindSurfaceModel(hv_SurfaceModelID, hv_ObjectModel3D1, 0.05, 0.2, 0, "false",
        ...
        visualize_object_model_3d(hv_WindowHandle, hv_ObjectModel3DRigidTrans.TupleConcat(hv_ObjectModel3D1),
            HTuple(), HTuple(), (HTuple("color_0").Append("color_1")), (HTuple("green").Append("gray")),
